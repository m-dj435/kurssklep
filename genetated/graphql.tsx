 ...
 * });
 */
export function useGetProductSlugsQuery(
  baseOptions?: Apollo.QueryHookOptions<
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetProductSlugsQuery, GetProductSlugsQueryVariables>(
    GetProductSlugsDocument,
    options
  );
}
export function useGetProductSlugsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetProductSlugsQuery,
    GetProductSlugsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetProductSlugsQuery,
    GetProductSlugsQueryVariables
  >(GetProductSlugsDocument, options);
}
export type GetProductSlugsQueryHookResult = ReturnType<
  typeof useGetProductSlugsQuery
>;
export type GetProductSlugsLazyQueryHookResult = ReturnType<
  typeof useGetProductSlugsLazyQuery
>;
export type GetProductSlugsQueryResult = Apollo.QueryResult<
  GetProductSlugsQuery,
  GetProductSlugsQueryVariables
>;
